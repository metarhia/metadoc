...
const parseFunction = (fn, lines) => {
  ...
  if (typeof fn === 'function') {
    ...
    const nativeParams = fn.toString().match(nativeParamRegex);
    if (nativeParams !== null) sig.nativeParams = nativeParams[0].slice(1, -1);

    if (sig.isClass) {
      const parent = Object.getPrototypeOf(fn.prototype).constructor.name;
      if (parent !== 'Object') sig.parentClass = parent;
    }
  }
